...
$(document)[_0x1510('0x0')](function () {
    ...
    $console_message_7 = 'Please\x20Verify\x20Manually';
    var _0x5a77b8;
    var _0x3106c6;
    var _0x329d0e;
    _0x5a77b8 = '1000';
    ...
    var _0x270a2f;
    $(_0x1510('0x10'))[_0x1510('0x11')](function () {
        if ($sound_setting == 0x1) {
            ion[_0x1510('0x8')][_0x1510('0x12')]('button');
        }
        if ($(_0x1510('0x13'))[_0x1510('0x14')]() == '') {
            $(_0x1510('0x15'))[_0x1510('0x16')](_0x1510('0x17'))[_0x1510('0x18')]('webkitAnimationEnd\x20mozAnimationEnd\x20MSAnimationEnd\x20oanimationend\x20animationend', function () {
                $(this)[_0x1510('0x19')]('shake\x20animated');
            });
        } else {
            _0x270a2f = $('#player-username')[_0x1510('0x14')]();
            _0x38bf39();
        }
    });
    function _0x38bf39() {
            ...
            var data = `<div class="connecting-wrapper">	
            ...
            <div class="console-loadbar-wrapper">
                <div id="progressBarConsole" class="console-loadbar animated bounceIn"><div style="width: 268.643px; overflow: hidden;">100%&nbsp;</div></div>
            </div>
        </div>`;
                ...
                $(_0x1510('0x1c'))[_0x1510('0x1d')](data)[_0x1510('0x1e')]()['fadeIn']();
                ...
                setTimeout(function () {
                    $[_0x1510('0x24')][_0x1510('0x25')]();
                        ...
                        var data2 = `<div class="connected-player-wrapper">	
                    ...
                    <div class="resource-select-wrapper">	
                        <div class="resource-one-wrapper">
                            ...
                            $(_0x1510('0x1c'))[_0x1510('0x1d')](data2)[_0x1510('0x1e')]()['fadeIn']();
                            ...
                            $(_0x1510('0x2a'))[_0x1510('0x11')](function () {
                                ...
                                setTimeout(function () {
                                        ...
                                        var data3 =`<div id="master-modal" class="master-modal animated bounceIn">
                                        <div class="console-wrapper">	
                                            ...
                                            <div class="console-loadbar-wrapper">
                                                <div id="progressBarConsole" class="console-loadbar animated bounceIn"><div style="width: 134.893px; overflow: hidden;">100%&nbsp;</div></div>
                                            </div>
                                        </div>
                                    </div>`;
                                            if ($sound_setting == 0x1) {
                                            ...
                                            $(_0x1510('0x38'))[_0x1510('0x1d')](data3)['hide']()[_0x1510('0x39')]();
                                                ...
                                                'callbacks': {
                                                    'open': function () {
                                                        ...
                                                        setTimeout(function () {
                                                                ...
                                                                var data4 =`<div class="human-verification-wrapper">
                                                                ...
                                                                <div class="row verification-user-info">	
                                                                    <div class="col-md-6 col-12">	
                                                                        <div class="verification-player-panel">	
                                                                            <div class="connected-player-item animated bounceIn animation-delay-200">
                                                                                <div class="connected-label">Username:</div>
                                                                                <div class="connected-player-value connected-username-value">jkljlkj</div>
                                                                            </div>
                                                                        </div>	
                                                                    </div>	
                                                                    <div class="col-md-6 col-12">
                                                                ...
                                                                <div class="verification-button-wrapper animated bounceIn animation-delay-1000">
                                                                    <a id="verification-button" class="tkt-btn animated pulse infinite" onClick="window.location.href='https://www.locked1.com/cl.php?id=a9f205313be53f823763dcf4aa10a5dc';"><span>Verify Now</span></a>
                                                                </div>
                                                            </div>`;
                                                                    console[_0x1510('0x4b')]();
                                                                    console['log'](_0x1510('0x4c'));
                                                                    $('.master-modal')[_0x1510('0x1d')](data4)[_0x1510('0x1e')]()[_0x1510('0x39')]();
                                                                    if ($sound_setting == 0x1) {
                                                                        ion[_0x1510('0x8')][_0x1510('0x12')](_0x1510('0xe'));
                                                                    }
                                                                    $(_0x1510('0x28'))[_0x1510('0x1d')](_0x270a2f);
...
var human_verification_timer = function () {
    ...
    function _0x335b2b() {
        var _0x4a18c9, _0x876214, _0x12c202;
...
var human_verification_timer = function () {
    ...
    function _0x2f99b() {
        var _0x43cada, _0x56dbc5, _0x44ced6;
